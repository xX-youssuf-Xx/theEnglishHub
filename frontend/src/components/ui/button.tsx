  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border-divider bg-background-card shadow-sm hover:bg-background-page hover:text-text-heading",
        secondary: "bg-primary-light text-primary-dark shadow-sm hover:bg-primary-light/80",
        ghost: "hover:bg-background-page hover:text-text-heading",
