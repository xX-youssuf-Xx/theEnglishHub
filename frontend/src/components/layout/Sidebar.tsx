...
export function Sidebar({ isMobileOpen, setIsMobileOpen, collapsed, setCollapsed }: SidebarProps) {
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-white/10">
          {!collapsed && (
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-bold text-lg">The English Hub</span>
            </div>
          )}
          {collapsed && <img src="/logo.svg" alt="Logo" className="w-8 h-8 mx-auto" />}
