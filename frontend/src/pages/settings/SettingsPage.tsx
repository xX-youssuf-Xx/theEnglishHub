...
const defaultPermissions = [
  ...
  { id: 2, name: 'إضافة/تعديل المعلمين', key: 'manage_teachers', enabled: true },
  { id: 3, name: 'تعديل الكلاسات', key: 'manage_classes', enabled: false },
  { id: 4, name: 'عرض التقارير المالية', key: 'view_financial_reports', enabled: false },
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="font-medium">{currentUser?.username}</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </div>
        ...
        <TabsContent value="permissions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>تحديد الصلاحيات المتاحة لدور المساعد</CardDescription>
            </CardHeader>
            <CardContent>
