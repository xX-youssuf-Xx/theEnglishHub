			...
			<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
				<div>
					...
					<p className="text-text-muted mt-1">
						تقارير مكلاسة عن أداء المركز المالي
					</p>
				</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									مقارنة الدخل والمصروفات على مدار 6 أشهر
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="h-80">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									الفترة: {dateRange.startDate.toLocaleDateString("ar-EG")} -{" "}
								...
								<div className="space-y-4">
									<div className="flex justify-between items-center p-4 bg-primary/10 rounded-lg">
										...
										<span className="text-xl font-bold text-primary">
											{financialReport?.income?.total?.toLocaleString() || 0}{" "}
											ج.م
										</span>
									</div>
									<div className="flex justify-between items-center p-4 bg-error/10 rounded-lg">
										...
										<span className="text-xl font-bold text-error">
											{financialReport?.expenses?.total?.toLocaleString() || 0}{" "}
											ج.م
										</span>
									</div>
								...
								<div>
									...
									<div className="space-y-2">
										{courseEnrollments.map((course) => (
											<div
												key={course.courseId}
												className="flex justify-between items-center p-3 bg-background-page rounded-lg"
											>
