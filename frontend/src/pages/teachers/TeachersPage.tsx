  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-text-heading">إدارة المعلمين</h1>
          <p className="text-text-muted mt-1">إدارة بيانات المعلمين والكلاسات</p>
        </div>
                        ...
                        <TableRow key={teacher.id} className="h-14">
                          <TableCell className="py-2">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <p className="font-medium text-text-heading">{teacher.fullName}</p>
                                {teacher.phone && (
                          ...
                          <TableCell className="py-2">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm">{teacher.classes?.length || 0} كلاس</span>
                            </div>
                          </TableCell>
                          <TableCell className="text-left py-2">
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem onClick={() => handleManageClasses(teacher.id, teacher.fullName)}>
