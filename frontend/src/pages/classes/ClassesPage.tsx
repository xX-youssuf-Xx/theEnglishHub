  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-text-heading">إدارة الكلاسات</h1>
          <p className="text-text-muted mt-1">إدارة الكلاسات والجداول الدراسية</p>
        </div>
                    ...
                    {classes.length === 0 ? (
                      ...
                      classes.map((cls) => (
                        <TableRow key={cls.id}>
                          <TableCell>
                            <div>
                              <p className="font-medium text-text-heading">{cls.name}</p>
                            </div>
                          </TableCell>
                          <TableCell>
                            ...
                            <div className="w-full max-w-[120px]">
                              ...
                              <div className="h-2 bg-border-divider rounded-full overflow-hidden">
                                <div
                                  ...
                                  style={{ width: `${Math.min(100, ((cls.completedSessions || 0) / Math.max(1, cls.totalSessions || 1)) * 100)}%` }}
                                />
                              </div>
                            </div>
                          </TableCell>
