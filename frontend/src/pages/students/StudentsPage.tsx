                          ...
                          <TableRow key={student.id}>
                            <TableCell>
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <p className="font-medium text-text-heading">{student.fullName}</p>
                                  {student.age && <p className="text-sm text-text-muted">{student.age} سنة</p>}
                                </div>
                              </div>
                            </TableCell>
                            <TableCell>
                            ...
                            <TableCell>
                              <span className="text-sm">{student.class?.name || 'غير مسجل'}</span>
                            </TableCell>
                            <TableCell>
                            ...
                            <TableCell className="text-left">
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  <DropdownMenuItem onClick={() => handleEdit(student.id, student.fullName)}>
                                    <Edit className="w-4 h-4 ml-2" />
                                    تعديل
                                  </DropdownMenuItem>
                                  <DropdownMenuItem onClick={() => handleEnroll(student.id, student.fullName)}>
                                    <GraduationCap className="w-4 h-4 ml-2" />
                                    تسجيل في كورس
                                  </DropdownMenuItem>
                                  <DropdownMenuItem onClick={() => handleRecordPayment(student.id, student.fullName)}>
